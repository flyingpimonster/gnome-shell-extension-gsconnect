...
describe('The runcommand plugin', function () {
    ...
    it('enables its GActions when connected', function () {
        ...
        expect(localPlugin.device.get_action_enabled('executeCommand')).toBe(true);
        expect(remotePlugin.device.get_action_enabled('executeCommand')).toBe(true);
    });
    ...
    it('disables its GActions when disconnected', function () {
        ...
        expect(localPlugin.device.get_action_enabled('executeCommand')).toBe(false);
        expect(remotePlugin.device.get_action_enabled('executeCommand')).toBe(false);
    });
});
