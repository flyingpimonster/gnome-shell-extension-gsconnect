...
describe('The mousepad plugin', function () {
    ...
    it('enables its GActions when connected', function () {
        ...
        expect(localPlugin.device.get_action_enabled('keyboard')).toBe(true);
        expect(remotePlugin.device.get_action_enabled('keyboard')).toBe(true);
    });
    ...
    it('disables its GActions when disconnected', function () {
        ...
        expect(localPlugin.device.get_action_enabled('keyboard')).toBe(false);
        expect(remotePlugin.device.get_action_enabled('keyboard')).toBe(false);
    });
});
