...
describe('The mpris plugin', function () {
    ...
    it('adds players', async function () {
        ...
        expect(localPlugin._mpris.hasPlayer('Music Player')).toBe(true);
        ...
        expect(remotePlugin._players.has('Music Player')).toBe(true);
    });
    ...
    it('sends and receives album art', async function () {
        ...
        const localUrl = Mock.getDataUri('album.png');
    ...
    it('removes players', async function () {
        ...
        expect(localPlugin._mpris.hasPlayer('Music Player')).toBe(false);

        await remotePlugin.awaitPacket('kdeconnect.mpris', {
            playerList: [],
        });
        expect(remotePlugin._players.has('Music Player')).toBe(false);
    });
