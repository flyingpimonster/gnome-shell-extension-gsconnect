...
describe('The clipboard plugin', function () {
    ...
    it('enables its GActions when connected', function () {
        ...
        expect(localPlugin.device.get_action_enabled('clipboardPush')).toBe(true);
        expect(localPlugin.device.get_action_enabled('clipboardPull')).toBe(true);

        expect(remotePlugin.device.get_action_enabled('clipboardPush')).toBe(true);
        expect(remotePlugin.device.get_action_enabled('clipboardPull')).toBe(true);
    });
    ...
    it('disables its GActions when disconnected', function () {
        ...
        expect(localPlugin.device.get_action_enabled('clipboardPush')).toBe(false);
        expect(localPlugin.device.get_action_enabled('clipboardPull')).toBe(false);

        expect(remotePlugin.device.get_action_enabled('clipboardPush')).toBe(false);
        expect(remotePlugin.device.get_action_enabled('clipboardPull')).toBe(false);
    });
});
