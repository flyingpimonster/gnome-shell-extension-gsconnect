...
describe('The ping plugin', function () {
    ...
    it('enables its GActions when connected', function () {
        ...
        expect(localPlugin.device.get_action_enabled('ping')).toBe(true);
        expect(remotePlugin.device.get_action_enabled('ping')).toBe(true);
    });
    ...
    it('disables its GActions when disconnected', function () {
        ...
        expect(localPlugin.device.get_action_enabled('ping')).toBe(false);
        expect(remotePlugin.device.get_action_enabled('ping')).toBe(false);
    });
});
